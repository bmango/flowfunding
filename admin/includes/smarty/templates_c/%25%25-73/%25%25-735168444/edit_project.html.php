<?php /* Smarty version 2.6.1, created on 2010-04-07 17:42:45
        ...
        <form name="form1" method="post" action="update_project.php">
          <table width="80%" border="0" align="center" cellspacing="5">
            ...
            <tr> 
              ...
              <td> <input name="display_ffch" type="checkbox" class="form" id="display_ffch" value="1" <?php echo $this->_tpl_vars['display_ffch']; ?>
 /></td>
            </tr>            
            <tr> 
...
" size="50"></td>
            ...
            <tr> 
              ...
              <td> <input name="display_funder" type="checkbox" class="form" id="display_funder" value="1" <?php echo $this->_tpl_vars['display_funder']; ?>
 /></td>
            </tr> 
            <tr> 
...
"></td>
            ...
            <tr> 
              ...
              <td> <input name="year_funded" type="text" class="form" id="year_funded" value="<?php echo $this->_tpl_vars['year_funded']; ?>
" size="6"></td>
            </tr>
            <tr> 
