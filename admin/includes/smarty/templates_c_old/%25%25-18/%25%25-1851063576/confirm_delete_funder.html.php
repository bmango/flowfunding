<?php /* Smarty version 2.6.1, created on 2007-04-16 22:51:21
         compiled from confirm_delete_funder.html */ ?>
  ...
  <tr> 
    <td valign="top"> <table width="100%" border="0" cellpadding="3" bgcolor="#336633">
      ...
      <div align="right" class="nav"> 
        <p align="left" class="paragraph">Delete funder <?php echo $this->_tpl_vars['id']; ?>
</p>
      </div>
      <p class="head">&nbsp;</p>
      <p class="paragraph">Are you sure you want to permanently remove the funder 
        <strong><?php echo $this->_tpl_vars['flow_funder_name']; ?>
</strong>?</p>
      <table width="221" border="0" cellpadding="5">
        <tr>
          <td width="112"><form name="form1" method="post" action="delete_funder.php">
...
">
          ...
          <td width="134"><form name="form2" method="post" action="view_funder.php">
