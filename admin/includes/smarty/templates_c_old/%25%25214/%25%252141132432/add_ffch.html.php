<?php /* Smarty version 2.6.1, created on 2007-04-19 00:56:44
         compiled from add_ffch.html */ ?>
  ...
  <tr>
    <td valign="top"> 
      ...
      <div align="right" class="nav">
        <p align="left" class="paragraph">Adding new FFCH name</p>
        <form name="form1" method="post" action="insert_ffch.php">
          <table width="80%" border="0" align="center" cellspacing="5">
            <tr> 
              <td width="20%" class="formText">ffch name</td>
              <td width="80%"><input name="ffch_name" type="text" class="form" id="ffch_name" size="50"></td>
            </tr>
            <tr> 
        ...
        <p align="left" class="paragraph"><a href="view_ffch.php">Return to list</a> 
          without saving changes</p>
      </div></td>
  </tr>
</table>
</body>
