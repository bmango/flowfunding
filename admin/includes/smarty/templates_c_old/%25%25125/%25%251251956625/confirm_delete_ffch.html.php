<?php /* Smarty version 2.6.1, created on 2007-04-16 17:45:23
         compiled from confirm_delete_ffch.html */ ?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
<title>Delete ffch</title>
  ...
  <tr> 
    <td valign="top"> <table width="100%" border="0" cellpadding="3" bgcolor="#336633">
      ...
      <div align="right" class="nav"> 
        <p align="left" class="paragraph">Delete ffch <?php echo $this->_tpl_vars['id']; ?>
</p>
      </div>
      <p class="head">&nbsp;</p>
      <p class="paragraph">Are you sure you want to permanently remove the ffch 
        name <strong><?php echo $this->_tpl_vars['ffch_name']; ?>
</strong>?</p>
      <table width="221" border="0" cellpadding="5">
        <tr>
          <td width="112"><form name="form1" method="post" action="delete_ffch.php">
              <input name="Submit" type="submit" class="formConfirm" value="Yes">
              <input name="id" type="hidden" id="id" value="<?php echo $this->_tpl_vars['id']; ?>
">
            </form></td>
          <td width="134"><form name="form2" method="post" action="view_ffch.php">
              <input name="Submit2" type="submit" class="formConfirmNo" value="No">
            </form></td>
          <td width="4">&nbsp;</td>
        </tr>
      </table>
