<?php /* Smarty version 2.6.1, created on 2007-04-19 00:56:28
         compiled from edit_ffch.html */ ?>
  ...
  <tr>
    <td valign="top"> 
      ...
      <div align="right" class="nav">
        ...
        <form name="form1" method="post" action="update_ffch.php">
          <table width="80%" border="0" align="center" cellspacing="5">
            <tr> 
              <td width="20%" class="formText">ffch name</td>
              <td width="80%"><input name="ffch_name" type="text" class="form" id="ffch_name" value="<?php echo $this->_tpl_vars['ffch_name']; ?>
" size="50"></td>
            </tr>
            <tr> 
...
"></td>
        ...
        <p class="paragraph"><a href="view_ffch.php">Return to list</a> without 
          saving changes</p>
      </div></td>
  </tr>
</table>
